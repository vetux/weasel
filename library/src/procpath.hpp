...
namespace ProcPath {
    ...
    inline std::string getProcessStatFile(Pid_t pid){
        return getProcessDirectory(pid) + PATH_STAT;
    }

    inline std::string getProcessStatmFile(Pid_t pid){
        return getProcessDirectory(pid) + PATH_STATM;
    }

    inline std::string getProcessCwdFile(Pid_t pid) {
        return getProcessDirectory(pid) + PATH_CWD;
    }
    ...
    inline std::string getThreadIoFile(Pid_t pid, Pid_t tid) {
